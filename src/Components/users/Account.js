...
function Account() {
    ...
    async function getcartbooks(){
        const response = await fetch("http://localhost:8080/library_management/getcartbooks?uid="+sessionStorage.getItem('uid')+"&user=Member");
    ...
    async function addbookstocart(book){
        //console.log(book);
             const response = await fetch("http://localhost:8080/library_management/checkout?userid=" + sessionStorage.getItem("uid") +"&bookid=" + book.Id + "&date=" + date()+"&user=Member");
             const data = await response.json();
                 //console.log(data);
 ...
 function date()
 {
    ...
    async function getreservedbooks(){
        const response = await fetch("http://localhost:8080/library_management/getreservedbooks?uid="+sessionStorage.getItem('uid')+"&user=Member");
            const data = await response.json();
            if(data.Status === "null"){
                return null;
            }
    ...
    async function removebookfromcart(book){
        const response = await fetch("http://localhost:8080/library_management/removebookfromcart?userid=" + sessionStorage.getItem("uid") +"&bookid=" + book.Id+"&user=Member");
        const data = await response.json();
        //console.log(data1)
        if(data.Status === "Success"){
    ...
    async function userinfo(){
        const response = await fetch("http://localhost:8080/library_management/userinfo?uid="+sessionStorage.getItem('uid')+"&user=Member");
            const data = await response.json();
            if(data.Status === "null"){
                return null;
            }
            ...
            <div className="card-body">
                ...
                <table>
                    ...
                    <tr>
                            <td>Id</td>
                            <td>:</td>
                            <td>{sessionStorage.getItem("uid")}</td>
                        </tr>
                    <tr>
                            <td>Username</td>
                            <td>:</td>
